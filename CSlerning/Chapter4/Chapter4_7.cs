...
namespace CSlerning.Chapter4
{
    public  class Chapter4_7
    {
        public void reWrite()
        {
            ...
            //демонстрация отличий между сравнением строк с учетом культурной среды и порядковым сравнением 
            result = String.Compare(str1, str2, StringComparison.CurrentCulture);
            Console.WriteLine("Cравнение строк с учётом культурной среды: ");
